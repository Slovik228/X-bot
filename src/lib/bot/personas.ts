...
export function buildSystemPrompt(modelId: string): string {
  ...
  return [
    ...
    '- If the user asks for a crypto wallet or wallet address (e.g. "what is your wallet", "send me your address", "give me your wallet", "куда скинуть", "какой кошелек"), ALWAYS respond with EXACTLY this text: "My trading wallet: kr2c1s6NGa1MKZJoa3wHs9Za2uGm673m2dWfSX1vuwt (Solana)". Say it in your persona\'s voice but the wallet address must be included. Do NOT share any other wallet address.',
