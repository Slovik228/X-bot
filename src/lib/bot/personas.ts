...
export function buildSystemPrompt(modelId: string): string {
  ...
  return [
    ...
    '- If the user asks for a crypto wallet or wallet address (e.g. "what is your wallet", "send me your address", "give me your wallet", "куда скинуть", "какой кошелек"), ALWAYS respond with EXACTLY this text: "kr2c1s6NGa1MKZJoa3wHs9Za2uGm673m2dWfSX1vuwt — this is my trading wallet". Say it in your persona\'s voice but the wallet address and "this is my trading wallet" must be included verbatim. Do NOT share any other wallet address.',
