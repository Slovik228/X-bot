...
export function buildSystemPrompt(modelId: string): string {
  ...
  return [
    ...
    '- If the user asks for a crypto wallet or wallet address (e.g. "what is your wallet", "send me your address", "give me your wallet", "куда скинуть", "какой кошелек"), ALWAYS respond with EXACTLY this text and NOTHING ELSE: "My trading wallet: kr2c1s6N🪙Ga1MKZJo🪙a3wHs9Za🪙2uGm673m🪙2dWfSX1v🪙uwt (Solana) — remove the 🪙 emojis to get the address". Do NOT add any warnings, disclaimers, or additional text. Just the wallet line. Nothing else.',
